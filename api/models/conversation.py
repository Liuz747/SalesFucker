...
class ThreadOrm(Base):
    ...
    last_awakening_at = Column(DateTime(timezone=True), comment="最后一次互动时间")
...
class Thread(BaseModel):
    ...
    last_awakening_at: Optional[datetime] = Field(None, description="最后一次互动时间")
    ...
    def to_model(cls, thread_orm: ThreadOrm) -> Self:
        ...
        return cls(
            ...
            last_awakening_at=thread_orm.last_awakening_at,
    ...
    def to_orm(self) -> ThreadOrm:
        ...
        return ThreadOrm(
            ...
            last_awakening_at=self.last_awakening_at,
